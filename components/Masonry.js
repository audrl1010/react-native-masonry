...
export const containMatchingUris = (r1, r2) =>
  isEqual(
    r1.map(brick => brick.uri),
    r2.map(brick => brick.uri)
  );
    ...
    switch (priority) {
      case PRIORITY_BALANCE:
        ...
        const newColumnHeights =
          heightsCopy[columnIndex] +
          (columnWidth * resolvedBrick.dimensions.height) /
            resolvedBrick.dimensions.width;
